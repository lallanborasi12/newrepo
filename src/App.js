...
const handleClear=()=>{
  ...
  return (
    <div className="App">
     ...
     <div>
              ...
              <div className='mb-3 flex flex-col flex-wrap'>
                <label>Age</label>
                <input className="border p-2 rounded-sm" type='Age' placeholder='Please Enter Age' onChange={(e)=>setAge(e.target.value)} value={age} />
              </div>
          <div className='mb-3 flex flex-col flex-wrap'>
                <label>Course</label>
  ...
  <tbody>
   { data.map((item, index) => { return(
      ...
      <td className="border border-slate-300 p-2">{item.age}</td>
